...
export const metadata: Metadata = {
  ...
  verification: {
    google: 'HdRSWk6MpnCYeVmYc-MqFoo20IPBzgtxLJ5GtwN2p5Y',
  }
}
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body className={inter.className}>
        ...
        <Toaster />
        {/* Floating WhatsApp across the site */}
        <WhatsAppFloat />
        <footer className="bg-gray-800 text-white py-8">
          <div className="container mx-auto px-6">
            <div className="flex flex-wrap justify-between">
              <div className="w-full md:w-1/4 mb-6 md:mb-0">
                <h3 className="text-lg font-semibold mb-2">CanadaVisa</h3>
                <p className="text-sm">Your trusted partner for Canadian immigration</p>
              </div>
              <div className="w-full md:w-1/4 mb-6 md:mb-0">
                <h3 className="text-lg font-semibold mb-2">Quick Links</h3>
                <ul className="text-sm">
                  <li><a href="/" className="hover:text-red-400 transition-colors">Home</a></li>
                  <li><a href="/jobs" className="hover:text-red-400 transition-colors">Jobs</a></li>
              ...
              <div className="w-full md:w-1/4 mb-6 md:mb-0">
                ...
                <p className="text-sm">123 Maple Street, Toronto, ON M5V 2T6</p>
                <p className="text-sm">Email: info@canadavisa.com</p>
                <p className="text-sm">Phone: +1 (863) 236-2530</p>
              </div>
            ...
            <div className="mt-8 border-t border-gray-700 pt-8 text-sm text-center">
              <p>&copy; {new Date().getFullYear()} CanadaVisa. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </body>
